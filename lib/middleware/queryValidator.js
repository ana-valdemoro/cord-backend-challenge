import { checkIntegerType, checkStringOrBooleanType,  checkExtraneousParams } from './elementaryValidation';
...
const validateQueryParameters = (requestQuery, queryRules) => {
  ...
  if (checkExtraneousParams(keysFromRules, keysFromQuery )){
    return {
      passQueryValidation: false,
      status: 422,
      message: 'Detected extraneous parameters in query string'
    };
  }
